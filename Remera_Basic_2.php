        ...
        <body>
            ...
            <div class="flex-prenda">
                <div class="imagenes">
                    ...
                    <img id="imagen" src="Multimedia\Fotos\basic21.jpg">
                    <div class="boton" id="adelante">
                        &#62
                    </div>
                    
                </div>
                <script src="js/Carrousel_RB2.js"></script>
                <!-- <div class="imagenes">
                    <img class="prueba" src="Multimedia\Fotos\basic21.jpg">
                </div> -->

                <div class="info">
                    <section class="titulo">
                        <h1><strong>REMERA BASIC 2</strong></h1>
                    </section>
                    <section class="descrip">
                        <h2>Remera de jersey de algodón con cuello redondo. <br>
                            – Calce oversized <br>
                            – Bordado de hilo blanco en costuras. <br><br>
