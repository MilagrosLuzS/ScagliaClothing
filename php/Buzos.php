...
<head>
    ...
    <title>Buzos</title>
    <link rel="stylesheet" type="text/css" href="../styles_buzos.css">
...
<body>
    ...
    <section class="buzos_general">
        ...
        <div class="contenido_grillas">
            <section class="buzos">
                <a href="Buzo_Basic.php"><img src="../Multimedia\Fotos\bbasic1.jpg" /></a>
                <div class="nombre_precio">
                    <h2><a href="Buzo_Basic.php">BUZO BASIC</a></h2>
                    <h3>$9999</h3>
                </div>
                <div class="boton">
                    <a href="Buzo_Basic.php" style="">COMPRAR</a>
                    <a href="#" style="">AÑADIR A LA WISHLIST</a>
                </div>
            </section>
            <section class="buzos">
                <a href="Hoodie_Cargo.php"><img src="../Multimedia\Fotos\cargo1.jpg" /></a>
                <div class="nombre_precio">
                    <h2><a href="#">HOODIE CARGO</a></h2>
                    <h3>$9999</h3>
                </div>
                <div class="boton">
                    <a href="Hoodie_Cargo.php" style="">COMPRAR</a>
                    <a href="#" style="">AÑADIR A LA WISHLIST</a>
                </div>
            </section>
            <section class="buzos">
                <a href="Hoodie_Patch.php"><img src="../Multimedia\Fotos\patch1.jpg" /></a>
                <div class="nombre_precio">
                    <h2><a href="Hoodie_Patch.php">HOODIE PATCH</a></h2>
                    <h3>$9999</h3>
                </div>
                <div class="boton">
                    <a href="Hoodie_Patch.php" style="">COMPRAR</a>
                    <a href="#" style="">AÑADIR A LA WISHLIST</a>
                </div>
            </section>
        </div>
